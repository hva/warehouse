...
angular.module('warehouse.providers', ['wh.shared.promise', 'wh.shared.urls']);
...
angular.module('warehouse', ['warehouse.services', 'warehouse.directives', 'warehouse.filters', 'warehouse.providers'])
    ...
    .config(function ($routeProvider, promiseProvider, templatesDir, warehouseUrls, urlsProvider) {
        var urls = warehouseUrls;
        urlsProvider._routes.warehouse = urls;
        $routeProvider
